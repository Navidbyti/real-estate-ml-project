...
برای جلوگیری از نیاز به آپلود و دانلود مکرر فایل‌های حجیم (~700 مگابایت)، لطفاً فایل‌های CSV داده‌ها را **در پوشه بالاتر از ریپازیتوری** قرار دهید، به عنوان مثال:
C:\Users\USERNAME\Documents\

و سپس در نوت‌بوک‌ها مسیر را به شکل نسبی یا مطلق به آن مسیر بدهید.  
