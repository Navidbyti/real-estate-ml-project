...
برای جلوگیری از نیاز به آپلود و دانلود مکرر فایل‌های حجیم (~700 مگابایت)، لطفاً فایل‌های CSV داده‌ها را **در پوشه بالاتر از ریپازیتوری** قرار دهید، 
PUSHE-GHABLI/real-estate-ml-project/

و سپس در نوت‌بوک‌ها به شکل نسبی به آن مسیر بدهید.  

**نکته:** این کار باعث می‌شود که نیازی به آپلود مداوم داده‌ها در GitHub نباشد و هر کسی بتواند نوت‌بوک‌ها را بدون حجم اضافه اجرا کند.
...
## راه اندازی گیت و VScode
اگر تو راه اندازی گیت مشکلی دارید این فایل رو بخونید:
https://github.com/Navidbyti/real-estate-ml-project/blob/main/GitVScodeSetup.ipynb
